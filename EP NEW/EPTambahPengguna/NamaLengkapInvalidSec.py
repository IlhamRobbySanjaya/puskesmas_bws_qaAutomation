...
class NamaLengkapInvalidSec(unittest.TestCase):
    def setUp(self):
    ...
    def test_nama_lengkap_invalid_sec(self):
        driver = self.driver
        ...
        driver.find_element_by_id("mui-5").send_keys("i")
        ...
        self.assertEqual("Nama Kurang Lengkap !", self.close_alert_and_get_its_text())
