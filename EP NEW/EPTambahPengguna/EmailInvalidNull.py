...
class EmailInvalidNull(unittest.TestCase):
    def setUp(self):
    ...
    def test_email_invalid_null(self):
        driver = self.driver
        ...
        driver.find_element_by_id("mui-5").send_keys("")
        ...
        self.assertEqual("Data Kurang Lengkap !", self.close_alert_and_get_its_text())
