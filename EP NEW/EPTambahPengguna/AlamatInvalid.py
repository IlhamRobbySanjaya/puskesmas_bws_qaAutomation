...
class AlamatInvalid(unittest.TestCase):
    def setUp(self):
    ...
    def test_alamat_invalid(self):
        ...
        driver.find_element_by_id("mui-5").send_keys("Tria Rahmawati")
        driver.find_element_by_id("mui-6").click()
        driver.find_element_by_id("mui-6").clear()
        driver.find_element_by_id("mui-6").send_keys("triarahmawati@gmail.com")
        driver.find_element_by_id("mui-7").click()
        driver.find_element_by_id("mui-7").clear()
        driver.find_element_by_id("mui-7").send_keys("B")
        ...
        driver.find_element_by_id("mui-9").send_keys("85259930755")
        ...
        self.assertEqual("Data Berhasil Ditambahkan !", self.close_alert_and_get_its_text())
        driver.get("https://sas-kia-deploy.vercel.app/dashboard/user")
