...
class EmailInvalidsec(unittest.TestCase):
    def setUp(self):
    ...
    def test_email_invalidsec(self):
        driver = self.driver
        ...
        driver.find_element_by_id("mui-6").send_keys("alvinsoetanto@gmail.c")
        ...
        self.assertEqual("The email address is badly formatted.", self.close_alert_and_get_its_text())
