...
class BatasAtasUsername(unittest.TestCase):
    def setUp(self):
    ...
    def test_batas_atas_username(self):
        driver = self.driver
        ...
        driver.find_element_by_id("email").send_keys("useruseruseruseruseruseruseruseruseruseru@gmail.com")
