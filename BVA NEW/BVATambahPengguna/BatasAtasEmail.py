...
class BatasAtasEmail(unittest.TestCase):
    def setUp(self):
    ...
    def test_batas_atas_email(self):
        driver = self.driver
        ...
        driver.find_element_by_id("mui-6").send_keys("Emailemailemailemailemailemailemailemailemailema123")
