...
class BatasBawahNamaLengkap(unittest.TestCase):
    def setUp(self):
    ...
    def test_batas_bawah_nama_lengkap(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//html/body/div[2]/div[3]/div/div/p/div/div[1]/div[1]/div/input").send_keys("N")
