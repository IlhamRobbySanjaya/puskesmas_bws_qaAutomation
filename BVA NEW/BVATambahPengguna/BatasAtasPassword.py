...
class BatasAtasPassword(unittest.TestCase):
    def setUp(self):
    ...
    def test_batas_atas_password(self):
        driver = self.driver
        ...
        driver.find_element_by_id("password").send_keys("Passwordpasswordpasswordpasswordpasswordpassword123")
