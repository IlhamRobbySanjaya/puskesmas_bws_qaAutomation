...
class BatasAtasSearchPengguna(unittest.TestCase):
    def setUp(self):
    ...
    def test_batas_atas_search_pengguna(self):
        driver = self.driver
        ...
        driver.find_element_by_xpath("//input[@value='Searchsearchsearchsearc123']").send_keys("Searchsearchsearchsearc123")
